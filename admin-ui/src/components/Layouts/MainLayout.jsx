  ...
  return (
    <>
	    <div className="flex min-h-screen">
			<aside className="bg-black w-28 sm:w-64 text-gray-300 flex flex-col justify-between px-7 py-12">
      <div>
			<div className="mb-10">
      ...
      <nav>
		...
		<div>
			<div className="flex bg-special-bg3 text-gray-300 px-4 py-3 rounded-md">
      ...
      <div className="border my-10 border-b-special-bg"></div>
        <div className="flex justify-between items-center">
          ...
          <header className="border border-b border-gray-300 px-6 py-7 flex justify-between items-center">
            <div className="flex items-center">
              <div className="font-bold text-2xl me-6">Username</div>  
              <div className="text-gray-600 flex">
                <Icon.ChevronRight size={20} /> {/* <-- DIBENERIN: ChevronDown jadi ChevronRight */}
                <span> May 19, 2026 </span>
              </div>  
            </div>
            <div className="flex items-center"> 
              <div className="me-10"><NotificationsIcon className="text-gray-800 scale-110" />
              </div>
